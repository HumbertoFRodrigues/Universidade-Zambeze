...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li class="<?php echo $active_menu == 'galeria' ? 'active' : ''; ?>"><a href="?page=gerenciar_especies">Gerenciar Especies</a></li>
            <li class="<?php echo $active_menu == 'galeria' ? 'active' : ''; ?>"><a href="?page=galeria_especies">Ver galeria</a></li>
            <li class="<?php echo $active_menu == 'perfil' ? 'active' : ''; ?>"><a href="?page=gerenciar_reservas">Reservas</a></li>
            <li class="<?php echo $active_menu == 'reserva' ? 'active' : ''; ?>"><a href="?page=listar_usuarios_visitantes">Usuarios</a></li>
