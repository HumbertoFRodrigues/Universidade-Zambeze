...
<body>
        ...
        <form id="form-perfil" method="POST">
            ...
            <div class="form-row">
                <div class="form-group" style="flex: 1;">
                    ...
                    <input type="text" name="nacionalidade" value="<?php echo htmlspecialchars($user['nacionalidade']); ?>" required>
                </div>

                <div class="form-group" style="flex: 1;">
                    <label>Ocupação:</label>
                    <input type="text" name="ocupacao" value="<?php echo htmlspecialchars($user['ocupacao']); ?>" required>
                </div>
            </div>
            ...
            <div class="form-group">
                <label>Senha:</label>
                <input type="password" name="senha" placeholder="Digite sua nova senha (opcional)">
            </div>

            <button type="submit" class="btn-submit" onclick="showSpinner()">Salvar Alterações</button>
    ...
    <div class="popup" id="popup">
        ...
        <button onclick="hidePopup()">Fechar</button>
    </div>
