...
## Funooes do pre processamento das Imagens
def grayscale(img):
...
dataGen= ImageDataGenerator(width_shift_range=0.1,   # alterar posicao width da imagem
                            height_shift_range=0.1,  # alterar posicao hight da imagem
                            zoom_range=0.2,  # colocar zoom
                            shear_range=0.1,  # mudar angulo
